...
> **สถานะปัจจุบัน:** ปิดขอบเขตเฟสวิจัยแล้ว งานวิจัยใหม่ การเชื่อมระบบนิเวศ การเพิ่มฟีเจอร์ และ T20 ยังคง **พักอยู่** เปิดสำรวจ snapshot สาธารณะได้โดยไม่เริ่มเก็บข้อมูล ช่องว่างหลักฐานยังเป็นข้อจำกัด ดู [สารบัญเอกสาร](docs/README.md) และ [โครงสร้างโค้ดปัจจุบัน](docs/refactor_summary.md)
